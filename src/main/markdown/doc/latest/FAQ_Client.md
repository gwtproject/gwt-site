...
<p>In this way, the variable over which we have created the closure is stored by value, and hence will retain that value even after the `doSomething` function goes out of
scope.</p>
